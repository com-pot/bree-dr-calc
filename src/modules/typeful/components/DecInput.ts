...
import * as FormInputRegistry from "../services/FormInputRegistry"
import {ModelObj} from "@/modules/typeful/components/types/ModelObj";
...
export default defineComponent({
  ...
  render() {
    const component = FormInputRegistry.getComponent(this.type)
    if (component) {
